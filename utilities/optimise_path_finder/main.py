...
from utilities.optimise_path_finder.PathFinder import PathFinder

# Load the path examples
from utilities.optimise_path_finder.path_examples import examples
...
if __name__ == "__main__":
    ...
    base_dir = Path("./utilities/optimise_path_finder/images")
